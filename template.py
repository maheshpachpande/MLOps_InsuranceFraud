...
project_name = "insurance_fraud_detection"
...
list_of_files = [
    ...
    f"{project_name}/configuration/mysql_conn.py",  # MTo connect MySQL database
    ...
    f"{project_name}/data_access/data.py",      # Handles data ingestion from various sources
